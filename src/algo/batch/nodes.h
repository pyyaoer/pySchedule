#ifndef PYSCHEDULE_ALGO_BATCH_NODES_H_
#define PYSCHEDULE_ALGO_BATCH_NODES_H_
...
class Gate : public Node {
 ...
 public:
  explicit Gate(int node_id, int msg_latency, int period, boost::asio::io_service& service)
    ...
    rho_(TENANT_NUM, GATE_NUM), delta_(TENANT_NUM, GATE_NUM) {
...
#endif // PYSCHEDULE_ALGO_BATCH_NODES_H_
